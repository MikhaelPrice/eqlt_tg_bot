...
public class Constants {
    ...
    public static final String THREE_FOUR_MILLIONS = "3000000 AED - 4000000 AED";
    ...
    public static final String TEN_THIRTY_MILLIONS = "10000000 AED - 30000000 AED";
    public static final String TEN_PLUS_MILLIONS = "30000000 AED+";
    ...
    public static final String SHOW_MORE_REAL_ESTATES = "Show more founded real estates";
